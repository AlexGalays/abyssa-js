...
var when=function(t){function e(t,e,n,i){return r(t).then(e,n,i)}function n(t,e){this.then=t,this.inspect=e}function r(t){return a(function(e){e(t)})}function i(t){return e(t,c)}function o(){function t(t,o,a){e.resolve=e.resolver.resolve=function(e){return i?r(e):(i=!0,t(e),n)},e.reject=e.resolver.reject=function(t){return i?r(c(t)):(i=!0,o(t),n)},e.notify=e.resolver.notify=function(t){return a(t),t}}var e,n,i;return e={promise:B,resolve:B,reject:B,notify:B,resolver:{resolve:B,reject:B,notify:B}},e.promise=n=a(t),e}function a(t){function e(t,e,n){return a(function(r,i,o){p?p.push(function(a){a.then(t,e,n).then(r,i,o)}):O(function(){h.then(t,e,n).then(r,i,o)})})}function r(){return h?h.inspect():b()}function i(t){p&&(h=s(t),l(p,h),p=B)}function o(t){i(c(t))}function u(t){p&&l(p,f(t))}var h,p=[];try{t(i,o,u)}catch(d){o(d)}return new n(e,r)}function s(t){return t instanceof n?t:t===Object(t)&&"then"in t?a(function(e,n,r){O(function(){try{var i=t.then;"function"==typeof i?A(i,t,e,n,r):e(u(t))}catch(o){n(o)}})}):u(t)}function u(t){var e=new n(function(n){try{return"function"==typeof n?s(n(t)):e}catch(r){return c(r)}},function(){return x(t)});return e}function c(t){var e=new n(function(n,r){try{return"function"==typeof r?s(r(t)):e}catch(i){return c(i)}},function(){return P(t)});return e}function f(t){var e=new n(function(n,r,i){try{return"function"==typeof i?f(i(t)):e}catch(o){return f(o)}});return e}function l(t,e){O(function(){for(var n,r=0;n=t[r++];)n(e)})}function h(t){return t&&"function"==typeof t.then}function p(t,n,r,i,o){return e(t,function(t){function s(r,i,o){function a(t){p(t)}function s(t){h(t)}var u,c,f,l,h,p,d,g;if(d=t.length>>>0,u=Math.max(0,Math.min(n,d)),f=[],c=d-u+1,l=[],u)for(p=function(t){l.push(t),--c||(h=p=R,i(l))},h=function(t){f.push(t),--u||(h=p=R,r(f))},g=0;d>g;++g)g in t&&e(t[g],s,a,o);else r(f)}return a(s).then(r,i,o)})}function d(t,e,n,r){function i(t){return e?e(t[0]):t[0]}return p(t,1,i,n,r)}function g(t,e,n,r){return y(t,R).then(e,n,r)}function v(){return y(arguments,R)}function _(t){return y(t,x,P)}function m(t,e){return y(t,e)}function y(t,n,r){return e(t,function(t){function i(i,o,a){var s,u,c,f,l;if(c=u=t.length>>>0,s=[],!c)return i(s),void 0;for(f=function(t,u){e(t,n,r).then(function(t){s[u]=t,--c||i(s)},o,a)},l=0;u>l;l++)l in t?f(t[l],l):--c}return a(i)})}function w(t,n){var r=A(L,arguments,1);return e(t,function(t){var i;return i=t.length,r[0]=function(t,r,o){return e(t,function(t){return e(r,function(e){return n(t,e,o,i)})})},q.apply(t,r)})}function x(t){return{state:"fulfilled",value:t}}function P(t){return{state:"rejected",reason:t}}function b(){return{state:"pending"}}function O(t){1===I.push(t)&&E()}function E(){j(S)}function S(){for(var t,e=0;t=I[e++];)t();I=[]}function R(t){return t}e.defer=o,e.resolve=r,e.reject=i,e.join=v,e.all=g,e.map=m,e.reduce=w,e.settle=_,e.any=d,e.some=p,e.isPromise=h,e.promise=a,n.prototype={otherwise:function(t){return this.then(B,t)},ensure:function(t){function e(){return r(t())}return this.then(e,e).yield(this)},yield:function(t){return this.then(function(){return t})},spread:function(t){return this.then(function(e){return g(e,function(e){return t.apply(B,e)})})},always:function(t,e){return this.then(t,t,e)}};var q,L,A,j,I,N,T,$,k,B;return I=[],N=t.setTimeout,j="function"==typeof setImmediate?setImmediate.bind(t):"object"==typeof process&&process.nextTick?process.nextTick:"object"==typeof vertx?vertx.runOnLoop:function(t){N(t,0)},T=Function.prototype,$=T.call,A=T.bind?$.bind($):function(t,e){return t.apply(e,L.call(arguments,2))},k=[],L=k.slice,q=k.reduce||function(t){var e,n,r,i,o;if(o=0,e=Object(this),i=e.length>>>0,n=arguments,n.length<=1)for(;;){if(o in e){r=e[o++];break}if(++o>=i)throw new TypeError}else r=n[1];for(;i>o;++o)o in e&&(r=t(r,e[o],o,e));return r},e}(this);!function(t){function e(){}function n(t,e,r){var i=/(?:([\w0-9]+:))?(?:\/\/(?:[^@]*@)?([^\/:\?#]+)(?::([0-9]+))?)?([^\?#]*)(?:(\?[^#]+)|\?)?(?:(#.*))?/;if(t&&!e){var o=n(),a=o._pathname,s=o._protocol;t=/^(?:[\w0-9]+\:)?\/\//.test(t)?0===t.indexOf("/")?s+t:t:s+"//"+o._host+(0===t.indexOf("/")?t:0===t.indexOf("?")?a+t:0===t.indexOf("#")?a+o._search+t:a.replace(/[^\/]+$/g,"")+t)}else t=e?t:P.href,(!R||r)&&(t=t.replace(/^[^#]*/,"")||"#",t=P.protocol+"//"+P.host+z.basepath+t.replace(new RegExp("^#[/]?(?:"+z.type+")?"),""));F.href=t;var u=i.exec(F.href),c=u[2]+(u[3]?":"+u[3]:""),f=u[4]||"/",l=u[5]||"",h="#"===u[6]?"":u[6]||"",p=f+l+h,d=f.replace(new RegExp("^"+z.basepath,"i"),z.type)+l;return{_href:u[1]+"//"+c+p,_protocol:u[1],_host:c,_hostname:u[2],_port:u[3]||"",_pathname:f,_search:l,_hash:h,_relative:p,_nohash:d,_special:d+h}}function r(){var t="";if(y)t+=y.getItem(C);else{var e=_.cookie.split(C+"=");e.length>1&&(t+=e.pop().split(";").shift()||"null")}try{U=x.parse(t)||{}}catch(n){U={}}$(j+"unload",function(){if(y)y.setItem(C,x.stringify(U));else{var t={};(t[P.href]=O.state)&&(_.cookie=C+"="+x.stringify(t))}},!1)}function i(n,r,i,o){i=i||{set:e};var a=!i.set,s=!i.get,u={configurable:!0,set:function(){a=1},get:function(){s=1}};try{L(n,r,u),n[r]=n[r],L(n,r,i)}catch(c){}if(!a||!s)if(n.__defineGetter__&&(n.__defineGetter__(r,u.get),n.__defineSetter__(r,u.set),n[r]=n[r],i.get&&n.__defineGetter__(r,i.get),i.set&&n.__defineSetter__(r,i.set)),a&&s||n!==t){if(!a||!s)try{try{var f=w.create(n);L(w.getPrototypeOf(f)===n?f:n,r,i);for(var l in n)"function"==typeof n[l]&&(f[l]=n[l].bind(n));try{o.call(f,f,n)}catch(c){}n=f}catch(c){L(n.constructor.prototype,r,i)}}catch(c){return!1}}else{try{var h=n[r];n[r]=null}catch(c){}if("execScript"in t)t.execScript("Public "+r,"VBScript");else try{L(n,r,{value:e})}catch(c){}n[r]=h}return n}function o(t,e,n){return n=n||{},t=t===Y?P:t,n.set=n.set||function(n){t[e]=n},n.get=n.get||function(){return t[e]},n}function a(t,e,n){t in Q?Q[t].push(e):arguments.length>3?$(t,e,n,arguments[3]):$(t,e,n)}function s(t,e,n){var r=Q[t];if(r){for(var i=r.length;--i;)if(r[i]===e){r.splice(i,1);break}}else k(t,e,n)}function u(n,r){var o=(""+("string"==typeof n?n:n.type)).replace(/^on/,""),a=Q[o];if(a){if(r="string"==typeof n?r:n,null==r.target)for(var s=["target","currentTarget","srcElement","type"];n=s.pop();)r=i(r,n,{get:"type"===n?function(){return o}:function(){return t}});(("popstate"===o?t.onpopstate:t.onhashchange)||e).call(t,r);for(var u=0,c=a.length;c>u;u++)a[u].call(t,r);return!0}return B(n,r)}function c(){var t=_.createEvent?_.createEvent("Event"):_.createEventObject();t.initEvent?t.initEvent("popstate",!1,!1):t.type="popstate",t.state=O.state,u(t)}function f(){M&&(M=!1,c())}function l(t,e,r,i){if(!R){var o=n(e);o._relative!==n()._relative&&(V=i,r?P.replace("#"+o._special):P.hash=o._special)}!q&&t&&(U[P.href]=t),M=!1}function h(e){if(V){D!==P.href&&c(),e=e||t.event;var r=n(V,!0),i=n();e.oldURL||(e.oldURL=r._href,e.newURL=i._href),r._hash!==i._hash&&u(e)}V=P.href}function p(t){setTimeout(function(){$("popstate",function(t){D=P.href,q||(t=i(t,"state",{get:function(){return O.state}})),u(t)},!1)},0),!R&&t!==!0&&O.location&&(g(O.location.hash),f())}function d(e){var r=e||t.event,i=r.target||r.srcElement,o="defaultPrevented"in r?r.defaultPrevented:r.returnValue===!1;if(i&&"A"===i.nodeName&&!o){var a=n(),s=n(i.getAttribute("href",2)),u=a._href.split("#").shift()===s._href.split("#").shift();u&&s._hash&&(a._hash!==s._hash&&(O.location.hash=s._hash),g(s._hash),r.preventDefault?r.preventDefault():r.returnValue=!1)}}function g(e){var n=_.getElementById(e=(e||"").replace(/^#/,""));if(n&&n.id===e&&"A"===n.nodeName){var r=n.getBoundingClientRect();t.scrollTo(m.scrollLeft||0,r.top+(m.scrollTop||0)-(m.clientTop||0))}}function v(){var e=_.getElementsByTagName("script"),a=(e[e.length-1]||{}).src||"",s=-1!==a.indexOf("?")?a.split("?").pop():"";s.replace(/(\w+)(?:=([^&]*))?/g,function(t,e,n){z[e]=(n||("basepath"===e?"/":"")).replace(/^(0|false)$/,"")});try{y=t.sessionStorage}catch(u){}$(j+"hashchange",h,!1);var c=[Y,A,G,t,K,O];q&&delete K.state;for(var f=0;f<c.length;f+=2)for(var l in c[f])if(c[f].hasOwnProperty(l))if("function"==typeof c[f][l])c[f+1][l]=c[f][l];else{var g=o(c[f],l,c[f][l]);if(!i(c[f+1],l,g,function(e,n){n===O&&(t.history=O=c[f+1]=e)}))return k(j+"hashchange",h,!1),!1;c[f+1]===t&&(Q[l]=Q[l.substr(2)]=[])}return z.redirect&&O.redirect(),!q&&x&&r(),R||_[I](j+"click",d,!1),"complete"===_.readyState?p(!0):(R||n()._relative===z.basepath||(M=!0),$(j+"load",p,!1)),!0}if(t.history){var _=t.document,m=_.documentElement,y=null,w=t.Object,x=t.JSON,P=t.location,b=t.history,O=b,E=b.pushState,S=b.replaceState,R=!!E,q="state"in b,L=w.defineProperty,A=i({},"t")?{}:_.createElement("a"),j="",I=t.addEventListener?"addEventListener":(j="on")&&"attachEvent",N=t.removeEventListener?"removeEventListener":"detachEvent",T=t.dispatchEvent?"dispatchEvent":"fireEvent",$=t[I],k=t[N],B=t[T],z={basepath:"/",redirect:0,type:"/"},C="__historyAPI__",F=_.createElement("a"),V=P.href,D="",M=!1,U={},Q={},G={onhashchange:null,onpopstate:null},J=function(e,n){var r=t.history!==b;r&&(t.history=b),e.apply(b,n),r&&(t.history=O)},K={redirect:function(e,r){if(z.basepath=r=null==r?z.basepath:r,z.type=e=null==e?z.type:e,t.top==t.self){var i=n(null,!1,!0)._relative,o=P.pathname+P.search;R?(o=o.replace(/([^\/])$/,"$1/"),i!=r&&new RegExp("^"+r+"$","i").test(o)&&P.replace(i)):o!=r&&(o=o.replace(/([^\/])\?/,"$1/?"),new RegExp("^"+r,"i").test(o)&&P.replace(r+"#"+o.replace(new RegExp("^"+r,"i"),e)+P.hash))}},pushState:function(t,e,n){E&&J(E,arguments),l(t,n)},replaceState:function(t,e,n){delete U[P.href],S&&J(S,arguments),l(t,n,!0)},location:{set:function(e){t.location=e},get:function(){return R?P:A}},state:{get:function(){return U[P.href]||null}}},Y={assign:function(t){0===(""+t).indexOf("#")?l(null,t):P.assign(t)},reload:function(){P.reload()},replace:function(t){0===(""+t).indexOf("#")?l(null,t,!0):P.replace(t)},toString:function(){return this.href},href:{get:function(){return n()._href}},protocol:null,host:null,hostname:null,port:null,pathname:{get:function(){return n()._pathname}},search:{get:function(){return n()._search}},hash:{set:function(t){l(null,(""+t).replace(/^(#|)/,"#"),!1,V)},get:function(){return n()._hash}}};v()&&(O.emulate=!R,t[I]=a,t[N]=s,t[T]=u)}}(window),/*! @license
 * abyssa <https://github.com/AlexGalays/abyssa-js/>
 * Author: Alexandre Galays | MIT License
 * v1.2.16 (2013-12-23T17:02:05.933Z)
 */
function(){var t=function(){function t(t){return"[object String]"===Object.prototype.toString.call(t)}function e(){}function n(t){return t.reduce(function(t,e){return t[e]=1,t},{})}function r(t){var e=[];for(var n in t)e.push(t[n]);return e}function i(t){var e={};for(var n in t)e[n]=t[n];return e}function o(t,e){for(var n in e)t[n]=e[n]}function a(t){var e=0;for(var n in t)e++;return e}function s(t,e){var n,r={};t=t||{};for(n in t)t[n]!==e[n]&&(r[n]=1);for(n in e)t[n]!==e[n]&&(r[n]=1);return r}function u(){var t=window&&window.location;if(!t)throw new Error("Browser location object cannot be obtained.");return t}function c(t,e){return(e?"":"/")+t.replace(/^\/+/,"").replace(/^([^?]*?)\/+$/,"$1").replace(/\/+\?/,"?")}function f(t){t=t||u();var e=t.href.indexOf("#/");return c(e>-1?t.href.slice(e+2):t.pathname+t.search)}function l(t){var e;try{e=when(t())}catch(n){e=when.defer().reject(n)}return e}function h(t,e,n,r){function i(t,e){return f.then(function(){u||t()},function(t){u||e(t)})}function o(){u=!0}var a,u,c,f,l=[],h=s(n,r),v=t===e;return t&&(a=g(t,e,v,h),l=_(t,a,v)),c=_(e,a,v).reverse(),f=p(c,l,r).then(function(){u||d(c,l,r)}),b.newTransitionStarted(),{from:t,fromParams:n,to:e,toParams:r,then:i,cancel:o}}function p(t,e,n){return e.forEach(function(t){if(t.exitPrereqs)var e=t._exitPrereqs=l(function(){return t.exitPrereqs()}).then(function(n){t._exitPrereqs===e&&(t._exitPrereqs.value=n)},function(e){var n=new Error('Failed to resolve EXIT prereqs of state "'+t.fullName+'": '+(e?e.message||e:"(no cause)"));return n.inner=e,S(n),when.defer().reject(n)})}),t.forEach(function(t){if(t.enterPrereqs)var e=t._enterPrereqs=l(function(){return t.enterPrereqs(n)}).then(function(n){t._enterPrereqs===e&&(t._enterPrereqs.value=n)},function(e){var n=new Error('Failed to resolve ENTER prereqs of state "'+t.fullName+'": '+(e?e.message||e:"(no cause)"));return n.inner=e,S(n),when.defer().reject(n)})}),when.all(t.concat(e).map(function(t){return t._enterPrereqs||t._exitPrereqs}))}function d(t,e,n){e.forEach(function(t){t.exit(t._exitPrereqs&&t._exitPrereqs.value),t._exitPrereqs=null}),b.allowed=!0,t.forEach(function(t){t.enter(n,t._enterPrereqs&&t._enterPrereqs.value),t._enterPrereqs=null}),b.allowed=!1}function g(t,e,n,r){var i,o;if(n)[t].concat(t.parents).reverse().forEach(function(t){if(!i)for(var e in r)if(t.params[e]||t.queryParams[e]){i=t;break}});else for(var a=0;a<t.parents.length;a++)if(o=t.parents[a],e.parents.indexOf(o)>-1){i=o;break}return i}function v(t,e,n){var r=t.parents,i=Math.min(r.length,r.indexOf(e)+(n?1:0));return[t].concat(r.slice(0,i))}function _(t,e,n){var r=!e||n;return v(t,e||t.root,r)}function m(){function t(t,e){d.name=t,d.parent=e,d.parents=r(),d.children=i(),d.fullName=a(),d.root=d.parents[d.parents.length-1],d.async=P.Async,f(function(t,e){e.init(t,d)}),p=!0}function n(){for(var t=d.path,e=d.parent;e;)e.path&&(t=e.path+"/"+t),e=e.parent;return c(t)}function r(){for(var t=[],e=d.parent;e;)t.push(e),e=e.parent;return t}function i(){var t=[];for(var e in _)t.push(_[e]);return t}function o(t){var e={};for(var n in t)t[n]._isState&&(e[n]=t[n]);return e}function a(){return d.parents.reduceRight(function(t,e){return t+e.name+"."},"")+d.name}function s(t){var e={enter:1,exit:1,enterPrereqs:1,exitPrereqs:1},n={};for(var r in t)e[r]||t[r]._isState||(n[r]=t[r]);return n}function u(t,e){if(void 0!==e){if(void 0!==d.ownData[t])throw new Error("State "+d.fullName+" already has data with the key "+t);return d.ownData[t]=e,void 0}for(var n=d;void 0===n.ownData[t]&&n.parent;)n=n.parent;return n.ownData[t]}function f(t){for(var e in _)t(e,_[e])}function l(t,e){if(p)throw new Error("States can only be added before the Router is initialized");if(_[t])throw new Error("The state {0} already has a child state named {1}".replace("{0}",e.name).replace("{1}",t));_[t]=e}function h(){return d.fullName}var p,d={_isState:!0},g=y(arguments),v=g.options,_=o(g.options);return d.path=g.path,d.params=g.params,d.queryParams=g.queryParams,d.states=_,d.enter=v.enter||e,d.exit=v.exit||e,d.enterPrereqs=v.enterPrereqs,d.exitPrereqs=v.exitPrereqs,d.ownData=s(v),d.init=t,d.getFullPath=n,d.data=u,d.addState=l,d.toString=h,d}function y(e){var r,i={path:"",options:{},params:{},queryParams:{}},o=e[0],a=e[1];return 1===e.length?t(o)?i.path=o:i.options=o:2===e.length&&(i.path=o,i.options="object"==typeof a?a:{enter:a}),i.path=c(i.path,!0),r=i.path.indexOf("?"),-1!==r&&(i.queryParams=i.path.slice(r+1),i.path=i.path.slice(0,r),i.queryParams=n(i.queryParams.split("&"))),i.path=i.path.replace(/[\:\{][^\/]+/g,function(t){var e,n=t.charAt(t.length-1);return"}"===n||":"===n?(e=t.substring(1,t.length-1),i.params[e]=1,t):(e=t.substring(1),i.params[e]=1,"{"+e+"}")}),i}function w(t){function n(t,n){u(t,n)||(N&&(O("Cancelling existing transition from {0} to {1}",N.from,N.to),N.cancel(),B.transition.cancelled.dispatch(N.from,N.to,N.fromParams,N.toParams)),O!==e&&O("Starting transition from {0}:{1} to {2}:{3}",j,JSON.stringify(I),t,JSON.stringify(n)),B.transition.started.dispatch(j,t,I,n),N=h(j,t,I,n),N.then(function(){var e,r=j,i=I;j=t,I=n,N=null,$||F||(e=A,O("Pushing state: {0}",e),history.pushState(e,window.document&&window.document.title||"",e)),O("Transition from {0} to {1} completed",r,t),B.transition.completed.dispatch(r,j,i,I),F=!1},function(e){N=null,E("Transition from {0} to {1} failed: {2}",j,t,e),B.transition.failed.dispatch(j,t,I,n,e),F=!1}))}function u(t,e){var n,r,i;return N?(n=N.to,r=N.toParams):(n=j,r=I),i=s(r,e),t===n&&0===a(i)}function l(t){return!t||t.indexOf("/")>-1||t.indexOf("?")>-1}function p(t,e){O("State not found: {0}",t),z.notFound?n(z.notFound,l(t)?{pathQuery:t}:{name:t,params:e||{}}):S(new Error('State "'+t+'" could not be found.'))}function d(t,e){return O("Router init"),g(),t=!w.ignoreInitialURL&&f()||t||"",O("Initializing to state {0}",t),m(t,e),window.onpopstate=function(t){var e=t.state||f();O("Popped state: {0}",e),$=!0,y(e)},k=!0,R(B),B}function g(){v(function(t,e){e.init(t)}),_(function(t){V[t.fullName]=t,t.route=C.addRoute(t.getFullPath()+":?query:"),t.route.matched.add(function(){T=!0,n(t,b(t,arguments))})})}function v(t){for(var e in z)t(e,z[e])}function _(t){function e(n){n.forEach(function(n){n.children.length?e(n.children):t(n)})}e(r(z))}function m(t,e){var n=l(t);O("Changing state to {0} {1}",t,n?"(path)":"(name)"),$=!1,n?y(t):x(t,e||{})}function y(t){A=c(t),T=!1,C.parse(A),T||p(A)}function x(t,e){var n=V[t];if(!n)return p(t,e);var r=n.route.interpolate(e);y(r)}function P(t,e){if(k)throw new Error("States can only be added before the Router is initialized");if(z[t])throw new Error("A state already exist in the router with the name "+t);O("Adding state {0}",t),z[t]=e}function b(t,e){var n,r=Array.prototype.slice.apply(e),i=r.pop(),a={};return t.getFullPath().replace(/(?:\{\w+?\})|(?:\:[^\:\/]+\:)/g,function(t){return n=t.slice(1,-1),a[n]=r.shift(),""}),i&&o(a,i),a}function q(t,e){var n={},r={},i=!1,a=V[t];if(!a)throw new Error("Cannot find state "+t);[a].concat(a.parents).forEach(function(t){o(r,t.queryParams)});for(var s in e)r[s]&&(n[s]=e[s],delete e[s],i=!0);return i&&(e.query=n),c(a.route.interpolate(e))}function L(){B.transition.ended.dispatch.apply(B.transition.ended,arguments)}var A,j,I,N,T,$,k,B={},z=i(t),C=crossroads.create(),F=!0,V={};return C.shouldTypecast=!0,C.ignoreState=!0,B.init=d,B.state=m,B.addState=P,B.link=q,B.transition={started:new signals.Signal,ended:new signals.Signal,completed:new signals.Signal,failed:new signals.Signal,cancelled:new signals.Signal},B.initialized=new signals.Signal,B.transition.completed.addOnce(function(t,e,n,r){B.initialized.dispatch(e,r)}),B.transition.completed.add(L),B.transition.failed.add(L),B.transition.cancelled.add(L),B}function x(t){if(t)throw"undefined"!=typeof console&&console.error(t),t}var P={};P.getParamDiff=s,P.getLocationObject=u,P.normalizePathQuery=c,P.getPathQuery=f;var b=function(){function t(t){if(!n.allowed)throw new Error("Async can only be called from within state.enter()");var e=when.defer();return r.push(e),when(t).then(function(t){r.indexOf(e)>-1&&e.resolve(t)},function(t){r.indexOf(e)>-1&&e.reject(t)}),e.promise}function e(){r.length=0}var n,r=[];return n={register:t,newTransitionStarted:e,allowed:!1}}();P.Async=b.register,P.State=m;var O=e,E=e;w.enableLogs=function(){function t(t){for(var e=t[0],n=Array.prototype.slice.call(t,1),r=0,i=n.length;i>r;r++)e=e.replace("{"+r+"}",n[r]);return e}O=function(){"undefined"!=typeof console&&console.log(t(arguments))},E=function(){"undefined"!=typeof console&&console.error(t(arguments))}};var S=x;w.setAsyncErrorHandler=function(t){var e=S;return S=t||x,e},P.Router=w;var R=function(t){function e(t){var e=t.which,n=t.button;return e||"undefined"==typeof n||(e=1&n?1:2&n?3:4&n?2:1),1===e}function n(t){for(;t;){if("A"===t.nodeName)return t;t=t.parentNode}}function r(e){var n=t.document.createElement("A");return n.href=e.href,n.protocol===i.protocol&&n.hostname===i.hostname&&(n.port||"80")===(i.port||"80")}if(t&&t.document){var i=u();return function(i,o){function a(o){var a=o||t.event,s=a.target||a.srcElement,u="defaultPrevented"in a?a.defaultPrevented:a.returnValue===!1;if(!(u||a.metaKey||a.ctrlKey||a.shiftKey||a.altKey)&&e(a)){var c=n(s);c&&c.getAttribute("href",2)&&!c.getAttribute("target")&&r(c)&&!/([a-z0-9_\-]+\:)?\/\/[^@]+@/.test(c.href)&&(a.preventDefault?a.preventDefault():a.returnValue=!1,i.state(f(c)))}}return o||(o=t.document),o.addEventListener?o.addEventListener("click",a):o.attachEvent&&o.attachEvent("onclick",a),function(){o.removeEventListener?o.removeEventListener("click",a):o.detachEvent&&o.detachEvent("onclick",a)}}}}(this);return P.interceptAnchorClicks=R,P};"function"==typeof define&&define.amd?define(["abyssa"],t):"undefined"!=typeof module&&module.exports?module.exports=t():window.Abyssa=t()}();