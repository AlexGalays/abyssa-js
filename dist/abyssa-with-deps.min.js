 ...
 */
!function(t){function e(){}function n(t,e,r){var i=/(?:([\w0-9]+:))?(?:\/\/(?:[^@]*@)?([^\/:\?#]+)(?::([0-9]+))?)?([^\?#]*)(?:(\?[^#]+)|\?)?(?:(#.*))?/;if(t&&!e){var o=n(),a=o._pathname,s=o._protocol;t=/^(?:[\w0-9]+\:)?\/\//.test(t)?0===t.indexOf("/")?s+t:t:s+"//"+o._host+(0===t.indexOf("/")?t:0===t.indexOf("?")?a+t:0===t.indexOf("#")?a+o._search+t:a.replace(/[^\/]+$/g,"")+t)}else t=e?t:P.href,(!E||r)&&(t=t.replace(/^[^#]*/,"")||"#",t=P.protocol+"//"+P.host+z.basepath+t.replace(new RegExp("^#[/]?(?:"+z.type+")?"),""));V.href=t;var u=i.exec(V.href),c=u[2]+(u[3]?":"+u[3]:""),f=u[4]||"/",h=u[5]||"",l="#"===u[6]?"":u[6]||"",p=f+h+l,d=f.replace(new RegExp("^"+z.basepath,"i"),z.type)+h;return{_href:u[1]+"//"+c+p,_protocol:u[1],_host:c,_hostname:u[2],_port:u[3]||"",_pathname:f,_search:h,_hash:l,_relative:p,_nohash:d,_special:d+l}}function r(t){var e="";if(y)e+=y.getItem(C);else{var n=_.cookie.split(C+"=");n.length>1&&(e+=n.pop().split(";").shift()||"null")}try{U=t.parse(e)||{}}catch(r){U={}}B(I+"unload",function(){if(y)y.setItem(C,t.stringify(U));else{var e={};(e[P.href]=O.state)&&(_.cookie=C+"="+t.stringify(e))}},!1)}function i(n,r,i,o){i=i||{set:e};var a=!i.set,s=!i.get,u={configurable:!0,set:function(){a=1},get:function(){s=1}};try{L(n,r,u),n[r]=n[r],L(n,r,i)}catch(c){}if(!a||!s)if(n.__defineGetter__&&(n.__defineGetter__(r,u.get),n.__defineSetter__(r,u.set),n[r]=n[r],i.get&&n.__defineGetter__(r,i.get),i.set&&n.__defineSetter__(r,i.set)),a&&s||n!==t){if(!a||!s)try{try{var f=w.create(n);L(w.getPrototypeOf(f)===n?f:n,r,i);for(var h in n)"function"==typeof n[h]&&(f[h]=n[h].bind(n));try{o.call(f,f,n)}catch(c){}n=f}catch(c){L(n.constructor.prototype,r,i)}}catch(c){return!1}}else{try{var l=n[r];n[r]=null}catch(c){}if("execScript"in t)t.execScript("Public "+r,"VBScript");else try{L(n,r,{value:e})}catch(c){}n[r]=l}return n}function o(t,e,n){return n=n||{},t=t===Q?P:t,n.set=n.set||function(n){t[e]=n},n.get=n.get||function(){return t[e]},n}function a(t,e,n){t in G?G[t].push(e):arguments.length>3?B(t,e,n,arguments[3]):B(t,e,n)}function s(t,e,n){var r=G[t];if(r){for(var i=r.length;--i;)if(r[i]===e){r.splice(i,1);break}}else k(t,e,n)}function u(n,r){var o=(""+("string"==typeof n?n:n.type)).replace(/^on/,""),a=G[o];if(a){if(r="string"==typeof n?r:n,null==r.target)for(var s=["target","currentTarget","srcElement","type"];n=s.pop();)r=i(r,n,{get:"type"===n?function(){return o}:function(){return t}});(("popstate"===o?t.onpopstate:t.onhashchange)||e).call(t,r);for(var u=0,c=a.length;c>u;u++)a[u].call(t,r);return!0}return $(n,r)}function c(){var t=_.createEvent?_.createEvent("Event"):_.createEventObject();t.initEvent?t.initEvent("popstate",!1,!1):t.type="popstate",t.state=O.state,u(t)}function f(){D&&(D=!1,c())}function h(t,e,r,i){if(!E){var o=n(e);o._relative!==n()._relative&&(F=i,r?P.replace("#"+o._special):P.hash=o._special)}!q&&t&&(U[P.href]=t),D=!1}function l(e){if(F){M!==P.href&&c(),e=e||t.event;var r=n(F,!0),i=n();e.oldURL||(e.oldURL=r._href,e.newURL=i._href),r._hash!==i._hash&&u(e)}F=P.href}function p(t){setTimeout(function(){B("popstate",function(t){M=P.href,q||(t=i(t,"state",{get:function(){return O.state}})),u(t)},!1)},0),!E&&t!==!0&&O.location&&(g(O.location.hash),f())}function d(e){var r=e||t.event,i=r.target||r.srcElement,o="defaultPrevented"in r?r.defaultPrevented:r.returnValue===!1;if(i&&"A"===i.nodeName&&!o){var a=n(),s=n(i.getAttribute("href",2)),u=a._href.split("#").shift()===s._href.split("#").shift();u&&(a._hash!==s._hash&&(O.location.hash=s._hash),g(s._hash),r.preventDefault?r.preventDefault():r.returnValue=!1)}}function g(e){var n=_.getElementById(e=(e||"").replace(/^#/,""));if(n&&n.id===e&&"A"===n.nodeName){var r=n.getBoundingClientRect();t.scrollTo(m.scrollLeft||0,r.top+(m.scrollTop||0)-(m.clientTop||0))}}function v(){var e=_.getElementsByTagName("script"),a=(e[e.length-1]||{}).src||"",s=-1!==a.indexOf("?")?a.split("?").pop():"";s.replace(/(\w+)(?:=([^&]*))?/g,function(t,e,n){z[e]=(n||("basepath"===e?"/":"")).replace(/^(0|false)$/,"")}),B(I+"hashchange",l,!1);var u=[Q,A,J,t,K,O];q&&delete K.state;for(var c=0;c<u.length;c+=2)for(var f in u[c])if(u[c].hasOwnProperty(f))if("function"==typeof u[c][f])u[c+1][f]=u[c][f];else{var h=o(u[c],f,u[c][f]);if(!i(u[c+1],f,h,function(e,n){n===O&&(t.history=O=u[c+1]=e)}))return k(I+"hashchange",l,!1),!1;u[c+1]===t&&(G[f]=G[f.substr(2)]=[])}return z.redirect&&O.redirect(),!q&&x&&r(x),E||_[N](I+"click",d,!1),"complete"===_.readyState?p(!0):(E||n()._relative===z.basepath||(D=!0),B(I+"load",p,!1)),!0}var _=t.document,m=_.documentElement,y=t.sessionStorage,w=t.Object,x=t.JSON,P=t.location,b=t.history,O=b,S=b.pushState,R=b.replaceState,E=!!S,q="state"in b,L=w.defineProperty,A=i({},"t")?{}:_.createElement("a"),I="",N=t.addEventListener?"addEventListener":(I="on")&&"attachEvent",j=t.removeEventListener?"removeEventListener":"detachEvent",T=t.dispatchEvent?"dispatchEvent":"fireEvent",B=t[N],k=t[j],$=t[T],z={basepath:"/",redirect:0,type:"/"},C="__historyAPI__",V=_.createElement("a"),F=P.href,M="",D=!1,U={},G={},J={onhashchange:null,onpopstate:null},K={redirect:function(e,r){if(z.basepath=r=null==r?z.basepath:r,z.type=e=null==e?z.type:e,t.top==t.self){var i=n(null,!1,!0)._relative,o=P.search,a=P.pathname;E?(i!=r&&new RegExp("^"+r+"$","i").test(a)&&P.replace(i),new RegExp("^"+r+"$","i").test(a+"/")?P.replace(r):new RegExp("^"+r,"i").test(a)||P.replace(a.replace(/^\//,r)+o)):a!=r&&P.replace(r+"#"+a.replace(new RegExp("^"+r,"i"),e)+o+P.hash)}},pushState:function(t,e,n){S&&S.apply(b,arguments),h(t,n)},replaceState:function(t,e,n){delete U[P.href],R&&R.apply(b,arguments),h(t,n,!0)},location:{set:function(e){t.location=e},get:function(){return E?P:A}},state:{get:function(){return U[P.href]||null}}},Q={assign:function(t){0===(""+t).indexOf("#")?h(null,t):P.assign(t)},reload:function(){P.reload()},replace:function(t){0===(""+t).indexOf("#")?h(null,t,!0):P.replace(t)},toString:function(){return this.href},href:{get:function(){return n()._href}},protocol:null,host:null,hostname:null,port:null,pathname:{get:function(){return n()._pathname}},search:{get:function(){return n()._search}},hash:{set:function(t){h(null,(""+t).replace(/^(#|)/,"#"),!1,F)},get:function(){return n()._hash}}};v()&&(O.emulate=!E,t[N]=a,t[j]=s,t[T]=u)}(window),/** @license
 * abyssa <https://github.com/AlexGalays/abyssa-js/>
 * Author: Alexandre Galays | MIT License
 * v1.1.2 (2013-09-16T12:45:55.674Z)
 */
function(){var t=function(){function t(t){return"[object String]"===Object.prototype.toString.call(t)}function e(){}function n(t){return t.reduce(function(t,e){return t[e]=1,t},{})}function r(t){var e=[];for(var n in t)e.push(t[n]);return e}function i(t){var e={};for(var n in t)e[n]=t[n];return e}function o(t,e){for(var n in e)t[n]=e[n]}function a(t){var e=0;for(var n in t)e++;return e}function s(t,e,n,r){function i(t,e){return p.then(function(){s||t()},function(t){s||e(t)})}function o(){s=!0}var a,s,h,p,d=[],g=t===e;return t&&(a=f(t,e,g,r),d=l(t,a,g)),h=l(e,a,g).reverse(),p=u(h,d,n).then(function(){s||c(h,d,n)}),_.newTransitionStarted(),{from:t,to:e,toParams:n,then:i,cancel:o}}function u(t,e,n){return e.forEach(function(t){if(t.exitPrereqs)var e=t._exitPrereqs=when(t.exitPrereqs()).then(function(n){t._exitPrereqs===e&&(t._exitPrereqs.value=n)},function(){throw new Error("Failed to resolve EXIT prereqs of "+t.fullName)})}),t.forEach(function(t){if(t.enterPrereqs)var e=t._enterPrereqs=when(t.enterPrereqs(n)).then(function(n){t._enterPrereqs===e&&(t._enterPrereqs.value=n)},function(){throw new Error("Failed to resolve ENTER prereqs of "+t.fullName)})}),when.all(t.concat(e).map(function(t){return t._enterPrereqs||t._exitPrereqs}))}function c(t,e,n){e.forEach(function(t){t.exit(t._exitPrereqs&&t._exitPrereqs.value)}),_.allowed=!0,t.forEach(function(t){t.enter(n,t._enterPrereqs&&t._enterPrereqs.value)}),_.allowed=!1}function f(t,e,n,r){var i,o;if(n)t.parents.slice().reverse().forEach(function(t){for(var e in r)if(t.params[e]||t.queryParams[e]){i=t;break}});else for(var a=0;a<t.parents.length;a++)if(o=t.parents[a],e.parents.indexOf(o)>-1){i=o;break}return i}function h(t,e,n){var r=t.parents,i=Math.min(r.length,r.indexOf(e)+(n?1:0));return[t].concat(r.slice(0,i))}function l(t,e,n){var r=!e||n;return h(t,e||t.root,r)}function p(){function t(t,e){p.name=t,p.parent=e,p.parents=r(),p.children=i(),p.fullName=a(),p.root=p.parents[p.parents.length-1],p.async=v.Async,c(function(t,e){e.init(t,p)}),l=!0}function n(){for(var t=p.path,e=p.parent;e;)e.path&&(t=e.path+"/"+t),e=e.parent;return t}function r(){for(var t=[],e=p.parent;e;)t.push(e),e=e.parent;return t}function i(){var t=[];for(var e in m)t.push(m[e]);return t}function o(t){var e={};for(var n in t)t[n]._isState&&(e[n]=t[n]);return e}function a(){return p.parents.reduceRight(function(t,e){return t+e.name+"."},"")+p.name}function s(t){var e={enter:1,exit:1,enterPrereqs:1,exitPrereqs:1},n={};for(var r in t)e[r]||t[r]._isState||(n[r]=t[r]);return n}function u(t,e){if(void 0!==e){if(void 0!==p.ownData[t])throw new Error("State "+p.fullName+" already has data with the key "+t);return p.ownData[t]=e,void 0}for(var n=p;void 0===n.ownData[t]&&n.parent;)n=n.parent;return n.ownData[t]}function c(t){for(var e in m)t(e,m[e])}function f(t,e){if(l)throw new Error("States can only be added before the Router is initialized");if(m[t])throw new Error("The state {0} already has a child state named {1}".replace("{0}",e.name).replace("{1}",t));m[t]=e}function h(){return p.fullName}var l,p={_isState:!0},g=d(arguments),_=g.options,m=o(g.options);return p.path=g.path,p.params=g.params,p.queryParams=g.queryParams,p.states=m,p.enter=_.enter||e,p.exit=_.exit||e,p.enterPrereqs=_.enterPrereqs,p.exitPrereqs=_.exitPrereqs,p.ownData=s(_),p.init=t,p.fullPath=n,p.data=u,p.addState=f,p.toString=h,p}function d(e){var r,i,o={path:"",options:{},params:{},queryParams:{}},a=e[0],s=e[1];return 1===e.length?t(a)?o.path=a:o.options=a:2===e.length&&(o.path=a,o.options="object"==typeof s?s:{enter:s}),r=o.path.indexOf("?"),-1!==r&&(o.queryParams=o.path.slice(r+1),o.path=o.path.slice(0,r),o.queryParams=n(o.queryParams.split("&"))),o.path=o.path.replace(/:\w*/g,function(t){return i=t.substring(1),o.params[i]=1,"{"+i+"}"}),o}function g(t){function n(t,n){u(t,n)||(A&&(m("Cancelling existing transition from {0} to {1}",A.from,A.to),A.cancel(),B.transition.cancelled.dispatch(A.from,A.to)),m!==e&&m("Starting transition from {0}:{1} to {2}:{3}",q,JSON.stringify(L),t,JSON.stringify(n)),B.transition.started.dispatch(q,t),A=s(q,t,n,c(L,n)),A.then(function(){var e,r=q;q=t,L=n,A=null,j||z||(e=("/"+E).replace("//","/"),m("Pushing state: {0}",e),history.pushState(e,document.title,e)),m("Transition from {0} to {1} completed",r,t),B.transition.completed.dispatch(r,q),z=!1},function(e){A=null,y("Transition from {0} to {1} failed: {2}",q,t,e),B.transition.failed.dispatch(q,t)}))}function u(t,e){var n,r,i;return A?(n=A.to,r=A.toParams):(n=q,r=L),i=c(r,e),t===n&&0===a(i)}function c(t,e){var n,r={};t=t||{};for(n in t)t[n]!==e[n]&&(r[n]=1);for(n in e)t[n]!==e[n]&&(r[n]=1);return r}function f(t){if(m("State not found: {0}",t),!k.notFound)throw new Error('State "'+t+'" could not be found');n(k.notFound)}function h(t){m("Router init"),l();var e=!g.ignoreInitialURL&&b()||t||"";return m("Initializing to state {0}",e||'""'),v(e),window.onpopstate=function(t){var e=t.state||b();m("Popped state: {0}",e),j=!0,_(e)},T=!0,B}function l(){p(function(t,e){e.init(t)}),I={},d(function(t){I[t.fullName]=t,t.route=$.addRoute(t.fullPath()+":?query:"),t.route.matched.add(function(){N=!0,n(t,O(t,arguments))})})}function p(t){for(var e in k)t(e,k[e])}function d(t){function e(n){n.forEach(function(n){n.children.length?e(n.children):t(n)})}e(r(k))}function v(t,e){var n=t.indexOf(".")>-1||I[t];m("Changing state to {0}",t||'""'),j=!1,n?x(t,e||{}):_(t)}function _(t){E=t,N=!1,$.parse(t),N||f(t)}function x(t,e){var n=I[t];if(!n)return f(t);var r=n.route.interpolate(e);_(r)}function P(t,e){if(T)throw new Error("States can only be added before the Router is initialized");if(k[t])throw new Error("A state already exist in the router with the name "+t);m("Adding state {0}",t),k[t]=e}function b(){var t=location.href.indexOf("#/");return t>-1?location.href.slice(t+2):(location.pathname+location.search).slice(1)}function O(t,e){var n,r=Array.prototype.slice.apply(e),i=r.pop(),a={};return t.fullPath().replace(/\{\w*\}/g,function(t){return n=t.slice(1,-1),a[n]=r.shift(),""}),i&&o(a,i),a}function S(t,e){var n={},r={},i=!1,a=I[t];if(!a)throw new Error("Cannot find state "+t);[a].concat(a.parents).forEach(function(t){o(r,t.queryParams)});for(var s in e)r[s]&&(n[s]=e[s],delete e[s],i=!0);return i&&(e.query=n),"/"+a.route.interpolate(e).replace("/?","?")}function R(t,e){B.transition.ended.dispatch(t,e)}var E,q,L,A,I,N,j,T,B={},k=i(t),$=crossroads.create(),z=!0;return $.shouldTypecast=!0,$.ignoreState=!0,w(B),B.init=h,B.state=v,B.addState=P,B.link=S,B.transition={started:new Signal,ended:new Signal,completed:new Signal,failed:new Signal,cancelled:new Signal},B.initialized=new Signal,B.transition.completed.addOnce(function(){B.initialized.dispatch()}),B.transition.completed.add(R),B.transition.failed.add(R),B.transition.cancelled.add(R),B}var v={},_=function(){function t(t){if(!n.allowed)throw new Error("Async can only be called from within state.enter()");var e=when.defer();return r.push(e),when(t).then(function(t){r.indexOf(e)>-1&&e.resolve(t)},function(t){r.indexOf(e)>-1&&e.reject(t)}),e.promise}function e(){r.length=0}var n,r=[];return n={register:t,newTransitionStarted:e,allowed:!1}}();v.Async=_.register,v.State=p;var m=e,y=e;g.enableLogs=function(){function t(t){for(var e=t[0],n=Array.prototype.slice.call(t,1),r=0,i=n.length;i>r;r++)e=e.replace("{"+r+"}",n[r]);return e}m=function(){console.log(t(arguments))},y=function(){console.error(t(arguments))}},v.Router=g;var w=function(t){function e(e){e=e||t.event;var n=e.which||e.button;return 1===n}function n(t){for(;t;){if("A"===t.nodeName)return t;t=t.parentNode}}if(t&&t.document&&t.location)return function(r){function i(i){if(!(i.defaultPrevented||i.metaKey||i.ctrlKey)&&e(i)){var o=n(i.target);o&&"_blank"!==o.getAttribute("target")&&o.hostname===t.location.hostname&&(i.preventDefault(),r.state(o.getAttribute("href")))}}t.document.addEventListener?t.document.addEventListener("click",i):t.document.attachEvent&&t.document.attachEvent("onclick",i)}}(this);return v};"function"==typeof define&&define.amd?define(["abyssa"],t):"undefined"!=typeof module&&module.exports?module.exports=t():window.Abyssa=t()}();